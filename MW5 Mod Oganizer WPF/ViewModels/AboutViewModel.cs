...
namespace MW5_Mod_Organizer_WPF.ViewModels
{
    public sealed partial class AboutViewModel : ObservableObject
    {
        ...
        public string License => "MW5 Mod Organizer does not have an Open Source License and falls under the default copyright laws. Therefore, it is not allowed to alter, sell or distribute this software without the permission of the author.";
